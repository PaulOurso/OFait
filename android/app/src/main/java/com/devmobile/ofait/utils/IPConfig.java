...
public class IPConfig {
    ...
    // Localhost
    public static final String DOMAIN_API = "http://192.168.21.169:"+String.valueOf(PORT_API)+"/api";
    // Distant
    ...
    // Localhost
    public static final String DOMAIN_SOCKET = "http://192.168.21.169:"+String.valueOf(PORT_SOCKET)+"/";
    // Distant
