...
public class FastDialog {
    ...
    public static void showDialog(Context c, int typeDialog, int res) {
    ...
    public static void showDialog(Context c, int typeDialog, int res, OnClickListener callbk) {
    ...
    public static Dialog showProgressDialog(Context c, int res) {
